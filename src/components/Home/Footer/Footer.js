                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12 footer-widget md-mb-39">
                            <div class="about-widget pr-15">
                                ...
                                <p class="desc">We understand issues occur and you shouldndt have to deal with them all alone. Therefore we have a, 24 hours help desk.</p>
                                <div class="btn-part">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 md-mb-32 footer-widget">
                            ...
                            <ul class="address-widget pr-40">
                                <li>
                                    ...
                                    <div class="desc"> Kenya, Nairobi, Abacus lane baba dogo road go down b1 </div>
                                </li>
                                <li>
                                    <i class="flaticon-call"></i>
                                    <div class="desc">
                                        <a href="tel:+254 724 540740 ">+254 724 540740 </a>
                                    </div>
                                </li>
                                <li>
